...
$GLOBALS['TL_LANG']['tl_settings']['fields']['backend_title'] = array('Backend Titel', 'Falls ein Backend Titel definiert wurde, wird dieser unterhalb des Contao-Schriftzugs im Backend-Header angezeigt.');
