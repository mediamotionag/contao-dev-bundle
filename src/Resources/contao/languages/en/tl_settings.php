...
$GLOBALS['TL_LANG']['tl_settings']['fields']['backend_title'] = array('Backend Title', 'If a backend title is defined, it is displayed below the Contao wordmark in the backend header.');
